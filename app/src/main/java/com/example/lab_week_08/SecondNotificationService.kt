...
class SecondNotificationService : Service() {
    ...
    override fun onCreate() {
        ...
        // Buat HandlerThread untuk background process
    ...
    private fun startForegroundService(): NotificationCompat.Builder {
        ...
        // Start foreground service dengan notifikasi
    ...
    private fun countDownFromFiveToZero(notificationBuilder: NotificationCompat.Builder) {
        ...
        // Countdown dari 5 ke 0 (berbeda dengan NotificationService pertama yang 10 ke 0)
        for (i in 5 downTo 0) {
            Thread.sleep(1000L)
